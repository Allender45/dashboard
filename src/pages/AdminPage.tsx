...
export function AdminPage() {
  ...
  return (
    <div className="min-h-screen p-6 text-[#e8eefc] [background:radial-gradient(900px_480px_at_30%_10%,rgba(71,120,255,0.24),transparent_70%),radial-gradient(700px_420px_at_70%_40%,rgba(245,197,66,0.16),transparent_65%),radial-gradient(900px_520px_at_40%_95%,rgba(80,200,120,0.12),transparent_60%),#0b1220]">
      <div className="mx-auto grid max-w-[980px] gap-4">
        <header className="flex items-center justify-between rounded-[16px] border border-white/10 bg-white/5 p-4">
        ...
        {error ? <div className="rounded-[14px] border border-red-400/20 bg-red-500/10 p-3">{error}</div> : null}
          ...
          <section className="grid gap-4 rounded-[16px] border border-white/10 bg-white/5 p-4">
            ...
            <div className="grid gap-2">
              ...
              <div className="grid grid-cols-2 gap-3 md:grid-cols-3">
                {images.map((img) => (
                  <div key={img.id} className="grid gap-2 rounded-[12px] border border-white/10 bg-black/20 p-2">
                    <img
